    ...
    <div className="p-[1.25rem]">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 mb-2">
          <h1 className="text-[1.15rem] font-bold">Distance from University</h1>
          <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              ...
              <Slider
                ...
                step={500}
                onValueChange={(value) =>
                  dispatch(setFilters({ selectedMonthlyFeeMinimum: value[0] }))
                }
              />
            </div>
            <div className="flex flex-col gap-2">
              ...
              <Slider
                ...
                step={500}
                onValueChange={(value) =>
                  dispatch(setFilters({ selectedMonthlyFeeMaximum: value[0] }))
                }
              />
            </div>
          </div>
        ...
        {(selectedReservedFor ||
          ...
          selectedMonthlyFeeMaximum ||
          selectedNoOfBeds || 
          (isFeaturedSelected || isTopRatedSelected || isNewestSelected)) && (
          <Button
            size="lg"
            variant="outline"
            className="mt-4"
